                        ...
                        <div className="modal-body">
                            <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
                                ...
                                <div style={{ flex: '0 0 150px', textAlign: 'center', margin: '0 auto' }}>
                                    <img 
                                        src="http://localhost:8080/recursos/portadas/portada-ejemplo.png" 
                                        alt="Portada del libro" 
                                        style={{ width: '100%', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.15)', objectFit: 'cover' }} 
                                    />
                                    <div style={{ marginTop: '15px' }}>
                                        <a 
                                            href="http://localhost:8080/recursos/pdf/libro-ejemplo.pdf" 
                                            target="_blank" 
                                            rel="noopener noreferrer" 
                                            className="btn-compact" 
                                            style={{ display: 'inline-block', textDecoration: 'none', backgroundColor: '#0284c7', color: 'white', padding: '8px 12px', borderRadius: '6px', fontWeight: 'bold', fontSize: '0.85rem', width: '100%', boxSizing: 'border-box' }}
                                        >
                                            Leer PDF (CDN)
                                        </a>
                                    </div>
                                </div>
                                <div className="libro-details" style={{ flex: '1', minWidth: '250px' }}>
                                    <div className="detail-section">
                                        <h3 style={{ marginTop: 0 }}>{libroSeleccionado.titulo}</h3>
